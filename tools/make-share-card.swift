...
func card1() {
    ...
    text(SITE, NSRect(x: 110, y: 160, width: W - 220, height: 52), size: 40, weight: .semibold)
...
func card2() {
    ...
    text(SITE, NSRect(x: 40, y: 120, width: W - 80, height: 56), size: 34, weight: .semibold,
         color: NSColor(srgbRed: 0.74, green: 0.83, blue: 1, alpha: 1))
    text("（评论区置顶也有这个网址）", NSRect(x: 60, y: 84, width: W - 120, height: 36),
         size: 24, color: NSColor(white: 1, alpha: 0.55))
    text("GitHub 搜 dsh-whale-girl-live2d · 模型来自 B 站 @氵六青",
